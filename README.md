...
- **SQL** — JOINs, sous-requêtes, CTEs, fonctions de fenêtre — MySQL Workbench
...
- 🗄️ [Analyse SQL ventes](https://github.com/nayal-souefou/analyse-ventes-sql) — SQL 
- 👥 [Analyse SQL employés](https://github.com/nayal-souefou/analyse-employes-sql) — SQL 
- 
## 📫 Me contacter
